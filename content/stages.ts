...
export const stages: Stage[] = [
{
  ...
  },
  {
    ...
    status: "open",
    projectSlugs: ["fn_square", "fn_polygon", "fn_house", "fn_snowflake", "fn_tree", "fn_toolbox", "fn_spiral", "fn_castle", "var_counter", "var_score", "var_lives", "var_speed", "var_parity", "var_gradient", "var_timer", "var_best", "cat_mouse", "guardian_dodge", "two_player", "message_relay", "two_actor_chat", "relay_race", "chorus", "animal_queue", "key_move", "key_maze", "key_piano", "catch_apple", "dodge_fall", "breakout_intro", "space_shooter", "reaction_game", "story_branch", "story_clickable", "story_adventure", "story_growth", "story_science", "story_card", "music_doremi", "music_twinkle", "music_loop", "music_random", "music_pitch_pos", "music_chord", "music_birthday", "music_compose", "math_mul_table", "math_factor_prime", "math_area", "math_fib", "math_prime_sieve", "math_polygon", "math_coords", "science_day_night", "science_seasons", "science_orbit", "science_water_cycle", "science_grow", "science_sound", "science_light", "list_shopping", "list_rollcall", "list_ranking", "list_lottery", "list_todo", "list_words", "list_scores", "list_queue"],
  },
  {
    id: "stage-13-16",
    ageRange: "13-16 岁",
