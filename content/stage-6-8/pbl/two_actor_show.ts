...
export const twoActorShowProject: CourseProject = {
  slug: "two_actor_show",
  category: "pbl",
  title: "双角色小剧场",
  ageGroup: "6-8 岁",
  description: "让二零和三七一起上台，切换场景、变换表情、你一句我一句演一出戏。",
  missionBrief:
    "把故事和表演组合起来！写一个程序：当开始运行时，先让二零变个表情说句话，再用「控制角色」切换到三七让它也表演，最后「切换场景」并说一句，讲完这一幕。",
  erLingHint:
    "① 绿色「当开始运行」里放「控制角色 二零」+「让二零表情变成 开心」+「说 大家好」；② 放「控制角色 三七」+「让三七表情变成 开心」+「说 我是三七」；③ 最后「切换场景 白天」+「说 第一幕结束」。点运行看两个伙伴演戏！",
  steps: [
    { id: 1, title: "用「当开始运行」启动小剧场" },
    { id: 2, title: "让两个伙伴都出场、变表情、开口说话" },
    { id: 3, title: "切换场景讲完一段故事" },
  ],
  cast: ["sanqi"],
