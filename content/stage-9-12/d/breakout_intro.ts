...
export const breakoutIntroProject: CourseProject = {
  slug: "breakout_intro",
  category: "key",
  title: "打砖块入门",
  ageGroup: "9-12 岁",
  description: "用键盘操控小球，撞碎顶部排列的砖块，看你能打碎几块。",
  missionBrief:
    "顶上一排砖块等着被撞碎！写一个操控程序：用「当按下」方向键让小球移动或转向，一「碰到星星（砖块）」就算打碎一块、分数 +1。把整排砖块都撞碎吧！",
  erLingHint:
    "① 拖「当开始运行」放「把变量 score 设为 0」；② 拖四个「当按下」方向键：↑/↓ 放「移动 40」、←/→ 放「转向 ±90」再「移动 40」；③ 在每个方向键里都接「如果 碰到星星 那么 变量 score 增加 1、说 碎啦！」；④ 点运行，用方向键把小球开去撞砖块。",
  steps: [
    { id: 1, title: "使用「当按下方向键」事件操控小球" },
    { id: 2, title: "撞到砖块（星星）就打碎并加分" },
