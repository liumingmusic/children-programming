...
│   │   ├── event/ cond/  game/  #     （目前 stage-6-8 共 61 个项目，每个文件即一个独立项目）
│   │   │   └── <slug>.ts        #       例：loop/square.ts 导出 squareProject
│   ├── stage-9-12/              #   图形化进阶：分类 A·函数 8/8 ✅ + 分类 B·变量 8/8 ✅ + 分类 C·多角色 4/8 + 分类 D·键盘 3/8（共 23 项目，自定义积木/变量/多角色/键盘运行时已落地）；分类 E–J 规划中
