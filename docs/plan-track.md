...
> 现状：已上线 **81 个**项目（分类1·序列 11/11 + 分类2·循环 10/10 + 分类3·画笔 10/10 + 分类4·事件 10/10 + 分类5·条件 10/10 + 分类6·游戏 10/10 + 分类8·音乐 10/10 + 分类9·数学 10/10；另 分类6·stars 1/1 计入分类6）。
...
> **6-8 阶段小计**：11 分类，已完成 **95 个引导项目**（含分类11·综合 4 个总结性项目）+ 造物工坊。引导项目明细：分类1·序列 11/11、分类2·循环 10/10、分类3·画笔 10/10、分类4·事件 10/10、分类5·条件 10/10、分类6·游戏 10/10、分类7·故事 10/10、分类8·音乐 10/10、分类9·数学 10/10、分类10·科学 10/10、分类11·综合 4/4。
...
>
> 现状（2026-08-15）：分类 A·函数 8/8 与 分类 B·变量 8/8 已完成并上线——「自定义积木」与「变量/计分」两个运行时能力已落地；分类 C·多角色 4/8（P0-1/P0-2 已落地）；分类 D·键盘 8/8 已完成（方向键 + 字母键弹琴 + 接苹果/打砖块/躲避/射击/反应力，含新增 apples 下落物场景）；分类 E–J 仍可解锁（音效 / 列表 / 坐标 待补）。
...
> **9-12 阶段小计**：10 分类，约 73 项目，已完成 **28**（分类 A·函数 8/8 + 分类 B·变量 8/8 + 分类 C·多角色 4/8 + 分类 D·键盘 8/8；自定义积木 / 变量 / 多角色碰撞·距离·消息广播 / 键盘(含 apples 下落物) 运行时已落地，音效 / 列表 / 坐标 待补）。
...
|---|---|---|---|---|
| 6-8 岁 | 11 | 111 | **95** + 造物工坊（含分类11·综合 4 个总结项目） | 分类7·故事 ✅ / 分类10·科学 ✅ / 分类11·综合 ✅ / 造物工坊 ✅ 全部交付 |
| 9-12 岁 | 10 | 77 | 28 | 音效 / 列表 / 坐标（自定义积木 / 变量 / 多角色碰撞·距离·消息广播 / 键盘含 apples 下落物 已落地） |
