...
> 现状：已上线 **71 个**项目（分类1·序列 11/11 + 分类2·循环 10/10 + 分类3·画笔 10/10 + 分类4·事件 10/10 + 分类5·条件 10/10 + 分类6·游戏 10/10 + 分类8·音乐 10/10；另 分类6·stars 1/1 计入分类6）。
...
> **6-8 阶段小计**：11 分类，111 项目，已完成 **71**（分类1·序列 11/11、分类2·循环 10/10、分类3·画笔 10/10、分类4·事件 10/10、分类5·条件 10/10、分类6·游戏 10/10、分类8·音乐 10/10）。
...
|---|---|---|---|---|
| 6-8 岁 | 11 | 111 | **71** | 变量 / 多角色 / 表情状态（分类7/9/10/11 待开发，音效已上线） |
