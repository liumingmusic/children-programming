...
>
> 现状（2026-08-15）：分类 A·函数 8/8 与 分类 B·变量 8/8 已完成并上线——「自定义积木」与「变量/计分」两个运行时能力已落地；分类 C·多角色已启动（碰撞·距离·消息广播 4/8，P0-1/P0-2 已落地）；分类 D·键盘已启动（基础 3/8，方向键 + 字母键弹琴 已落地）；分类 E–J 仍可解锁（音效 / 列表 / 坐标 待补）。
...
> **9-12 阶段小计**：10 分类，约 73 项目，已完成 **23**（分类 A·函数 8/8 + 分类 B·变量 8/8 + 分类 C·多角色 4/8 + 分类 D·键盘 3/8；自定义积木 / 变量 / 多角色碰撞·距离·消息广播 / 键盘 运行时已落地，音效 / 列表 / 坐标 待补）。
...
| 9-12 岁 | 10 | 77 | 23 | 音效 / 列表 / 坐标（自定义积木 / 变量 / 多角色碰撞·距离·消息广播 / 键盘 已落地） |
